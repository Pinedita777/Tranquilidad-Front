...
const tips = [
    // Pagina 1
<<<<<<< HEAD
    { title: "Practica la Respiración Profunda", img: "/inicio-de-sesion/Modulo-iniciar-sesion/home/imagenes/repirar.png", recommendation: "Haz respiraciones lentas y profundas..." },
    { title: "Realiza Ejercicio Regular", img: "/inicio-de-sesion/Modulo-iniciar-sesion/home/imagenes/ejercicio.png", recommendation: "Hacer ejercicio 30 minutos al día..." },
    { title: "Mantén una Dieta Balanceada", img: "/inicio-de-sesion/Modulo-iniciar-sesion/home/imagenes/alimentacion.png", recommendation: "Consume frutas, verduras y proteínas..." },
    { title: "Practica la Meditación", img: "/inicio-de-sesion/Modulo-iniciar-sesion/home/imagenes/meditacion.png", recommendation: "Dedica 10 minutos diarios a la meditación..." },
    { title: "Prioriza el Sueño", img: "/inicio-de-sesion/Modulo-iniciar-sesion/home/imagenes/sueño.png", recommendation: "Dormir al menos 7 horas es clave..." },
    { title: "Establece Metas Diarias", img: "/inicio-de-sesion/Modulo-iniciar-sesion/home/imagenes/metas.png", recommendation: "Establecer metas pequeñas cada día..." },
    // Paginas 2
    { title: "Evita el Estrés", img: "/inicio-de-sesion/Modulo-iniciar-sesion/home/imagenes/estres.png", recommendation: "Tómate un tiempo para relajarte cada día..." },
    ...
    // Página 4
    { title: "Desconéctate de la Tecnología", img: "/inicio-de-sesion/Modulo-iniciar-sesion/home/imagenes/tecnologia.png", recommendation: "Dedica al menos una hora al día sin tecnología para relajarte." },
    { title: "Escribe un Diario", img: "/inicio-de-sesion/Modulo-iniciar-sesion/home/imagenes/escribir.png", recommendation: "Llevar un diario ayuda a reflexionar sobre tus emociones y experiencias." },
    { title: "Aprende a Decir No", img: "/inicio-de-sesion/Modulo-iniciar-sesion/home/imagenes/no.png", recommendation: "Poner límites mejora tu salud mental y evita el agotamiento." },
    { title: "Haz Estiramientos", img: "/inicio-de-sesion/Modulo-iniciar-sesion/home/imagenes/estirar.png", recommendation: "Los estiramientos ayudan a reducir la tensión muscular y mejoran la circulación." },
    { title: "Realiza un Acto de Bondad", img: "/inicio-de-sesion/Modulo-iniciar-sesion/home/imagenes/bondad.png", recommendation: "Pequeños actos de bondad elevan tu ánimo y el de los demás." },
    { title: "Haz una Limpieza Digital", img: "/inicio-de-sesion/Modulo-iniciar-sesion/home/imagenes/limpieza.png", recommendation: "Ordena tu espacio digital para reducir el estrés y mejorar la organización." },
    // Página 5
    { title: "Prueba la Respiración con Diafragma", img: "/inicio-de-sesion/Modulo-iniciar-sesion/home/imagenes/respiracion.png", recommendation: "Respirar con el diafragma mejora la relajación y reduce la ansiedad." },
    { title: "Escucha un Podcast Educativo", img: "/inicio-de-sesion/Modulo-iniciar-sesion/home/imagenes/escucha.png", recommendation: "Los podcasts son una gran forma de aprender algo nuevo mientras te relajas." },
    { title: "Practica el Yoga", img: "/inicio-de-sesion/Modulo-iniciar-sesion/home/imagenes/yoga.png", recommendation: "El yoga ayuda a mejorar la flexibilidad y reduce el estrés." },
    { title: "Escribe una Lista de Tareas", img: "/inicio-de-sesion/Modulo-iniciar-sesion/home/imagenes/lista.png", recommendation: "Organizar tu día con una lista de tareas mejora la productividad." },
    { title: "Cocina tu Propia Comida", img: "/inicio-de-sesion/Modulo-iniciar-sesion/home/imagenes/cocinar.png", recommendation: "Preparar tus comidas es más saludable y te permite controlar los ingredientes." },
    { title: "Limita el Tiempo en Redes Sociales", img: "/inicio-de-sesion/Modulo-iniciar-sesion/home/imagenes/redes.png", recommendation: "Reducir el tiempo en redes sociales mejora el bienestar emocional." }
];
=======
